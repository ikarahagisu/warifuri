...
if "doctors_df" not in st.session_state:
    st.session_state.doctors_df = pd.DataFrame([
        {"名前": "医師A", "現在の患者数": 8, "割り振り後max患者数": 25, "大変さのmaxスコア": 5},
        {"名前": "医師B", "現在の患者数": 3, "割り振り後max患者数": 25, "大変さのmaxスコア": 5},
        {"名前": "医師C", "現在の患者数": 2, "割り振り後max患者数": 25, "大変さのmaxスコア": 5},
        {"名前": "医師D", "現在の患者数": 1, "割り振り後max患者数": 10, "大変さのmaxスコア": 3},
    ])
